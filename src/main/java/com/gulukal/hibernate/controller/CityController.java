package com.gulukal.hibernate.controller;
...
import com.gulukal.hibernate.util.IDatabaseCrud;

public class CityController implements IDatabaseCrud<CityEntity>{
